function [varargout] = libs_Bullock2018(param,cav,varargin)
...
Hs1     = Hs(ind);
lnSnum  = fso+fq+fA+fh+s1*log(cav);
lnLIBS  = max(lnSnum + k0+ k1*min(Hs1,12)^2 + k2*min(Q,61) + k3*max(Q-61,0),lnSnum);
