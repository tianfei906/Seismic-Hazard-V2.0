function [varargout] = libs_Bullock2018Dv(param,cav,varargin)
...
Hs1     = Hs(ind);
lnLIBS  = k0+ k1*min(Hs1,12)^2 + k2*min(Q,61) + k3*max(Q-61,0);
lnLIBS  = lnLIBS*ones(size(cav));
