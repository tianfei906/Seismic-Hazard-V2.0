function[vout]=BT2007(ky,Ts,im,varargin)
...
%%
if Ts<0.05
    lnd = -0.22-2.83*log(ky)-0.333*(log(ky))^2+0.566*log(ky)*log(im)+3.04*log(im)-0.244*(log(im)).^2+1.5*Ts;
else
    lnd = -1.10-2.83*log(ky)-0.333*(log(ky))^2+0.566*log(ky)*log(im)+3.04*log(im)-0.244*(log(im)).^2+1.5*Ts;
end
