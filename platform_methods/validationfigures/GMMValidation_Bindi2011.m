...
switch filename
    case 'Bindi2011_1.png'
        ...
        on        = logsp(1,1,30);
        [lny,sig] = Bindi2011(0.01,5.7*on,Rjb,'EC8-B','strike-slip','geoh');
    ...
    case 'Bindi2011_2.png'
        Rjb       = logsp(0.1,200,30);
        on        = logsp(1,1,30);
        [lny,sig] = Bindi2011(0.01,6.4*on,Rjb,'EC8-B','reverse','geoh');
    ...
    case 'Bindi2011_3.png'
        Rjb       = logsp(0.1,200,30);
        on        = logsp(1,1,30);
        [lny,sig] = Bindi2011(0.01,6.9*on,Rjb,'EC8-C','normal','geoh');
    ...
    case 'Bindi2011_4.png'
        Rjb       = logsp(0.1,200,30);
        on        = logsp(1,1,30);
        [lny,sig] = Bindi2011(0.01,4.6*on,Rjb,'EC8-B','unspecified','geoh');
