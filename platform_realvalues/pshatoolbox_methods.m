...
if group ==1
    i = 0;
    ME(1:49,1)=struct('label',[],'str',[],'func',[],'type',[],'ref',[]);
    % regular GMMs
    ...
    i=i+1; ME(i).label = 'Abrahamson et al. 2018';       ME(i).func = @BCHydro2018;                ME(i).type='regular';  ME(i).ref='https://peer.berkeley.edu/sites/default/files/2018_02_abrahamson_9.10.18.pdf';
    ...
    i=i+1; ME(i).label = 'Montalva et al. 2017 (HQ) ';   ME(i).func = @MontalvaBastias2017HQ;      ME(i).type='regular';  ME(i).ref='https://doi.org/10.1785/0120160221';
    i=i+1; ME(i).label = 'SIBER-RISK 2019';              ME(i).func = @SiberRisk2019;              ME(i).type='regular';  ME(i).ref='https://doi.org/10.1177/8755293019891723';
    ...
    i=i+1; ME(i).label = 'Garcia-Soto Jaimes 2017 (H/V)';ME(i).func = @GarciaJaimes2017HV;         ME(i).type='regular';  ME(i).ref='https://doi.org/10.1785/0120160273';
    ...
    i=i+1; ME(i).label = 'Idriss 2008 - NGA';            ME(i).func = @I2008;                      ME(i).type='regular';  ME(i).ref='https://doi.org/10.1193/1.2924362';
    i=i+1; ME(i).label = 'Chiou Youngs 2008 - NGA';      ME(i).func = @CY2008;                     ME(i).type='regular';  ME(i).ref='https://doi.org/10.1193/1.2894832';
    i=i+1; ME(i).label = 'Boore Atkinson 2008 - NGA';    ME(i).func = @BA2008;                     ME(i).type='regular';  ME(i).ref='https://doi.org/10.1193/1.2830434';
    i=i+1; ME(i).label = 'Campbell Bozorgnia 2008 - NGA';ME(i).func = @CB2008;                     ME(i).type='regular';  ME(i).ref='https://doi.org/10.1193/1.2857546';
    i=i+1; ME(i).label = 'Abrahamson Silva 2008 - NGA';  ME(i).func = @AS2008;                     ME(i).type='regular';  ME(i).ref='https://doi.org/10.1193/1.2924360';
    ...
    i=i+1; ME(i).label = 'Idriss 2014 - NGAW2';          ME(i).func = @I2014;                      ME(i).type='regular';  ME(i).ref ='https://doi.org/10.1193/070613EQS195M';
    i=i+1; ME(i).label = 'CY 2014 - NGAW2';              ME(i).func = @CY2014;                     ME(i).type='regular';  ME(i).ref='https://doi.org/10.1193/072813eqs219m';
    i=i+1; ME(i).label = 'CB 2014 - NGAW2';              ME(i).func = @CB2014;                     ME(i).type='regular';  ME(i).ref='https://doi.org/10.1193/062913eqs175m';
    i=i+1; ME(i).label = 'BSSA 2014 - NGAW2';            ME(i).func = @BSSA2014;                   ME(i).type='regular';  ME(i).ref='https://doi.org/10.1193/070113eqs184m';
    i=i+1; ME(i).label = 'ASK 2014 - NGAW2';             ME(i).func = @ASK2014;                    ME(i).type='regular';  ME(i).ref='https://doi.org/10.1193/070913eqs198m';
    i=i+1; ME(i).label = 'Akkar & Boomer 2007';          ME(i).func = @AkkarBoomer2007;            ME(i).type='regular';  ME(i).ref='https://doi.org/10.1002/eqe.679';
    i=i+1; ME(i).label = 'Akkar & Boomer 2010';          ME(i).func = @AkkarBoomer2010;            ME(i).type='regular';  ME(i).ref='https://doi.org/10.1785/gssrl.81.2.195';
    i=i+1; ME(i).label = 'Arroyo et al. 2010';           ME(i).func = @Arroyo2010;                 ME(i).type='regular';  ME(i).ref='https://doi.org/10.1007/s10950-010-9200-0';
    i=i+1; ME(i).label = 'Bindi et al. 2011';            ME(i).func = @Bindi2011;                  ME(i).type='regular';  ME(i).ref='https://doi.org/10.1007/s10518-011-9313-z';
    i=i+1; ME(i).label = 'Kanno et al. 2006';            ME(i).func = @Kanno2006;                  ME(i).type='regular';  ME(i).ref='http://dx.doi.org/10.1785/0120050138';
    i=i+1; ME(i).label = 'Cauzzi et al. 2015';           ME(i).func = @Cauzzi2015;                 ME(i).type='regular';  ME(i).ref='https://doi.org/10.1007/s10518-014-9685-y';
    ...
    i=i+1; ME(i).label = 'Travasarou, Bray, Abrahamson 2003'; ME(i).func = @TBA03;                 ME(i).type='regular';  ME(i).ref='https://doi.org/10.1002/eqe.270';
    i=i+1; ME(i).label = 'Bullock et al, 2017';          ME(i).func = @BU17;                       ME(i).type='regular';  ME(i).ref='https://doi.org/10.1785/0120160388';
    i=i+1; ME(i).label = 'Campbell,Bozorgnia 2010';      ME(i).func = @CB10;                       ME(i).type='regular';  ME(i).ref='https://doi.org/10.1193/1.3457158';
    i=i+1; ME(i).label = 'Campbell,Bozorgnia 2011';      ME(i).func = @CB11;                       ME(i).type='regular';  ME(i).ref='https://doi.org/10.1016/j.nucengdes.2011.04.020';
    i=i+1; ME(i).label = 'Campbell,Bozorgnia 2019';      ME(i).func = @CB19;                       ME(i).type='regular';  ME(i).ref='https://doi.org/10.1193/090818EQS212M';
    ...
    % Conditional Model
    i=i+1; ME(i).label = 'Macedo et al. 2019';           ME(i).func = @Macedo2019;                 ME(i).type='cond';     ME(i).ref='https://doi.org/10.1785/0120180297';
    i=i+1; ME(i).label = 'Macedo et al. 2020';           ME(i).func = @Macedo2020;                 ME(i).type='cond';     ME(i).ref='www.google.com';
