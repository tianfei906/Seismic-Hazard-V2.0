...
handles.default_AEP   = logsp(1,5e-5,10)';
if nargin>4
    param = varargin{1};
    Tcss  = varargin{2};
    AEP   = varargin{3};
    ...
    param = {2,'1','0.01 - 2','0.04 - 0.4','5.5 - 8',1,'0 - 1000','350 - 760','5 - 150','0 - 3000','0 - 1000','32','1000','700 - 0.01','100'};
