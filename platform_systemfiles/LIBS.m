...
handles = wipeLIBS(handles);
if isfield(handles,'defaultpath_others')
    pathname = handles.defaultpath_others;
...
function launchCPT_explorer_Callback(hObject, eventdata, handles)
CPT_explorer(handles.param)
...
function OptionsLIBS_Callback(hObject, eventdata, handles)
...
function LIBS_Deagg_Menu_Callback(hObject, eventdata, handles)
