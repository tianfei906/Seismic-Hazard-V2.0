...
load icons_PSDA2.mat c jp
handles.toggle1.CData             = c{1}; 
handles.ax2Limits.CData           = c{2}; 
handles.CDataClosed               = c{3}; 
handles.CDataOpen                 = c{4}; 
handles.ref1.CData                = c{5};
handles.ColorSecondaryLines.CData = c{6};
handles.runREG.CData              = c{7}; 
handles.runCDM.CData              = c{7};
handles.CDM_DisplayOptions.CData  = c{8};
handles.REG_DisplayOptions.CData  = c{8}; 
handles.deleteButton.CData        = handles.CDataOpen; 
handles.treebutton.CData          = c{9}; 
