...
handles.go_1.CData              = c{2};
handles.go_2.CData              = c{3};
handles.go_3.CData              = c{4};
handles.go_4.CData              = c{5};
handles.GridManager.CData       = c{6};
handles.ShowNodes.CData         = c{7};
handles.Ruler.CData             = c{8};
handles.Undock.CData            = c{10};
handles.wiz1.CData              = c{11};
