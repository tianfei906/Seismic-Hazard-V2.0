...
load icons_SeismicHazard c
handles.engine.CData               = c{1};
handles.Exit_button.CData          = c{2};
handles.form1                      = c{3};
handles.form2                      = c{4};
handles.addLeg.CData               = c{5};
handles.ax2Limits.CData            = c{6};
handles.OpenRef.CData              = c{7};
handles.ColorSecondaryLines.CData  = c{8};
handles.po_refresh_GE.CData        = c{9};
handles.RefreshButton.CData        = c{10};
handles.restore_axis.CData         = c{11};
handles.Distance_button.CData      = c{12};
