...
weight = permute(handles.sys.weight(:,5),[2 3 1]);
lam    = permute(handles.lambda,[2,3,4,1]);
lam    = prod(bsxfun(@power,lam,weight),3);
handles.meanUHS = uhspectrum(handles.im,lam,hazlevel);
% average hazard
