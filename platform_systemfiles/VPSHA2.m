function varargout = VPSHA2(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @VPSHA2_OpeningFcn, ...
    'gui_OutputFcn',  @VPSHA2_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function VPSHA2_OpeningFcn(hObject, eventdata, handles, varargin) %#ok<*INUSL>
...
function varargout = VPSHA2_OutputFcn(hObject, eventdata, handles)
varargout{1} = [];
...
function runVPSHA2_Callback(hObject, eventdata, handles)
...
[handles.lambda,handles.MRE,handles.MRD] = runhazardV2(im,IM,h,opt,sources,Nsource,rho);
