...
switch str
    ...
    case 'MAB2019',                       IND = [T,T,F,F,S];             % [M,Rrup,mechanism,region,Vs30];
    case 'MAL2020',                       IND = [T,T,T,F,F,S];           % [M,Rrup,Rjb,HWeffect,dip,Vs30];
    case 'MMLA2020',                      IND = [T,T,S];                 % [M,Rrup,Vs30];
    case 'ML2021',                        IND = [T,T,F,S];               % [M,Rrup,mechanism,Vs30];
    case 'MCAVdp2021',                    IND = [T,T,F,S];               % [M,Rrup,mechanism,Vs30];
end
