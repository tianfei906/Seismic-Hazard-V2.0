...
switch fun
    ...
    case 'MAL2020'
        ...
        [~,B]=ismember({me.type},'regular');
        me=me(B==1);
        [~,val(4)] = intersect({'include','exclude'},gmm.txt{4});
        [~,val(5)] = intersect({me.str},gmm.txt{5});
end
...
switch gmm.type
    case 'regular'
        param = paramreg(fun);
    case 'cond'
        cnfun  = func2str(gmm.cond);
        param  = paramreg(cnfun);
    ...
    function media=getmedia(x)
        media=[];
        switch x
            case 'Youngs1997',                media = 'rock';
            case 'AtkinsonBoore2003',         media = 'nehrpb';
            case 'Zhao2006',                  media = VS30;
            case 'Mcverry2006',               media = 'B';
            case 'ContrerasBoroschek2012',    media = 'rock';
            case 'BCHydro2012',               media = VS30;
            case 'BCHydro2018',               media = VS30;
            case 'Kuehn2020',                 media = VS30;
            case 'Parker2020',                media = VS30;
            case 'Arteta2018',                media = 'rock';
            case 'Idini2016',                 media = VS30;
            case 'MontalvaBastias2017',       media = VS30;
            case 'MontalvaBastias2017HQ',     media = VS30;
            case 'Montalva2018'
            case 'SiberRisk2019',             media = VS30;
            case 'Garcia2005'
            case 'Jaimes2006'
            case 'Jaimes2015'
            case 'Jaimes2016'
            ...
            case 'GarciaJaimes2017VH'
            case 'GA2011'
            case 'SBSA2016',                  media = VS30;
            case 'GKAS2017',                  media = VS30;
            case 'Bernal2014'
            case 'Sadigh1997',                media = 'rock';
            case 'I2008',                     media = VS30;
            case 'CY2008',                    media = VS30;
            case 'BA2008',                    media = VS30;
            case 'CB2008',                    media = VS30;
            case 'AS2008',                    media = VS30;
            case 'AS1997h',                   media = 'rock';
            case 'I2014',                     media = VS30;
            case 'CY2014',                    media = VS30;
            case 'CB2014',                    media = VS30;
            case 'BSSA2014',                  media = VS30;
            case 'ASK2014',                   media = VS30;
            case 'AkkarBoomer2007'
            case 'AkkarBoomer2010'
            case 'Akkar2014'
            case 'Arroyo2010'
            case 'Bindi2011',                 media = 'A';
            case 'Kanno2006'
            case 'Cauzzi2015'
            case 'DW12'
            case 'FG15',                media = VS30;
            case 'TBA03'
            case 'BU17'
            case 'CB10',                media = VS30;
            case 'CB11',                media = VS30;
            case 'CB19',                media = VS30;
            case 'KM06'
            case 'medianPCEbchydro'
            case 'medianPCEnga'
        end
