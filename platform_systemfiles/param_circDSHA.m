...
for jj=1:Ndepend
    ...
    switch str_test
        ...
        case 'GKAS2017',                      param = [M,Rrup,Rjb,Rx,'unk',Ztor,dip,width,VS30,usp];
    ...
    switch gmm.type
        case 'cond'
            switch func2str(gmm.handle)
                ...
                case 'MAL2020' , param = {M,rrup,rjb,VS30 ,gmm.cond,param{:}}; %#ok<CCAT>
                case 'MMLA2020', param = {M,rrup,VS30 ,gmm.cond,param{:}}; %#ok<CCAT>
                case 'ML2021'  , param = {M,rrup,VS30 ,gmm.cond,param{:}}; %#ok<CCAT>
            end
        case 'frn'
