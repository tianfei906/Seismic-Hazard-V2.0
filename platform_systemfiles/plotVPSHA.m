...
if isfield(handles,'im3level')
    val = handles.im3level.Value;
else
    val = 1;
end
...
switch handles.butt2.Value
    case 0, y = handles.MRE(:,:,val); str = 'MRE';
    case 1, y = handles.MRD(:,:,val); str = 'MRD';
end
